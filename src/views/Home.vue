...
<div class="home">
    <h1>My recipes</h1>
    <button 
        @click="togglePopup">Add new recipe</button>
        ...
        <div class="popup-content">
            ...
            <form 
                ...
                <div class="group">
                    ...
                    <button type="button"
                    @click="addNewIngredient">Add Ingredient</button>
                </div>
                ...
                <div class="group">
                    ...
                    :key="i">
                        <textarea
                        v-model="newRecipe.method[i-1]"></textarea>
                    </div>
                    <button type="button"
                    @click="addNewStep ">Add step</button>
                </div>
